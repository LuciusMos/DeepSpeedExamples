...
# python train_bloomz.py --actor-model bigscience/bloomz-7b1 --reward-model bigscience/bloomz-560m --deployment-type single_node --output-dir clean-bloomz --step 3
