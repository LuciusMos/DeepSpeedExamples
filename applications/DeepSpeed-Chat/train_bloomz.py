...
# python train_bloomz.py --actor-model bigscience/bloomz-7b1-mt --reward-model bigscience/bloomz-560m --deployment-type single_gpu --output-dir bloomz-560m  --step 2
