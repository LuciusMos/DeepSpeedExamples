...
python inference_compare.py \
    --output_file goliath-full.json \
    --model_name_or_path_sft /home/zhaoliangxuan/DeepSpeedExamples/applications/DeepSpeed-Chat/bloomz-560m-523-leftpad/actor-models/bloomz-7b1/ \
