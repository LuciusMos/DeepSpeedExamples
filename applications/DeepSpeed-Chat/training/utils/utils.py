...
def load_hf_tokenizer(model_name_or_path, fast_tokenizer=True, padding_side="right"):
    if os.path.exists(model_name_or_path):
        ...
        if os.path.exists(model_json):
            ...
            tokenizer = AutoTokenizer.from_pretrained(model_name, fast_tokenizer=True, padding_side=padding_side)
    else:
        tokenizer = AutoTokenizer.from_pretrained(model_name_or_path, fast_tokenizer=True, padding_side=padding_side)
    return tokenizer
